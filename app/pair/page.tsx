      ...
      <div className="mx-auto max-w-md">
        ...
        {error ? (
          <ScrollAnimation direction="scale">
            <div className="rounded-2xl border border-red-500/30 bg-red-500/10 p-8 text-center backdrop-blur-lg shadow-lg shadow-red-500/20">
          ...
          <ScrollAnimation direction="up" delay={0.1}>
            <div className="glass-effect rounded-2xl p-6 sm:p-8 smooth-transition shadow-2xl shadow-purple-500/20">
